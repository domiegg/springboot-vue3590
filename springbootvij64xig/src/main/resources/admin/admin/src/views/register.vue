	...
	<div>
		...
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230922/f59a972478aa46a7b92dc46fca8ea573.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center bottom","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"border":"0px solid #f6f6f6","padding":"30px 20px","boxShadow":"0 20px 20px rgba(0, 0, 0, .1)","margin":"0px 0","borderRadius":"20px","textAlign":"center","background":"rgba(255,255,255,0)","width":"600px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"padding":"0px","margin":"0px auto 30px","borderColor":"#eee","color":"rgba(255, 255, 255, 1)","textAlign":"center","display":"inline-block","background":"none","borderWidth":"0px","width":"50%","lineHeight":"40px","fontSize":"24px","borderStyle":"solid","fontWeight":"500"}' class="title">果树的生长信息管理系统注册</div>
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 15px","textAlign":"left","flexWrap":"wrap","display":"flex","width":"60%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='nongchangzhu'">
					<div v-if="true" :style='{"padding":"0 6px","color":"#96a8be","textAlign":"right","left":"-120px","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"14px","position":"absolute","order":"2"}' class="lable" :class="changeRules('nongchangzhanghao')?'required':''">农场账号：</div>
					<el-input  v-model="ruleForm.nongchangzhanghao"  autocomplete="off" placeholder="农场账号"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 15px","textAlign":"left","flexWrap":"wrap","display":"flex","width":"60%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='nongchangzhu'">
					<div v-if="true" :style='{"padding":"0 6px","color":"#96a8be","textAlign":"right","left":"-120px","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"14px","position":"absolute","order":"2"}' class="lable" :class="changeRules('fuzeren')?'required':''">负责人：</div>
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 15px","textAlign":"left","flexWrap":"wrap","display":"flex","width":"60%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='nongchangzhu'">
					<div v-if="true" :style='{"padding":"0 6px","color":"#96a8be","textAlign":"right","left":"-120px","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"14px","position":"absolute","order":"2"}' class="lable" :class="changeRules('dianhuahaoma')?'required':''">电话号码：</div>
					<el-input  v-model="ruleForm.dianhuahaoma"  autocomplete="off" placeholder="电话号码"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 15px","textAlign":"left","flexWrap":"wrap","display":"flex","width":"60%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='zhuanjia'">
					<div v-if="true" :style='{"padding":"0 6px","color":"#96a8be","textAlign":"right","left":"-120px","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"14px","position":"absolute","order":"2"}' class="lable" :class="changeRules('zhuanjiazhanghao')?'required':''">专家账号：</div>
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 15px","textAlign":"left","flexWrap":"wrap","display":"flex","width":"60%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='zhuanjia'">
					<div v-if="true" :style='{"padding":"0 6px","color":"#96a8be","textAlign":"right","left":"-120px","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"14px","position":"absolute","order":"2"}' class="lable" :class="changeRules('zhuanjiaxingming')?'required':''">专家姓名：</div>
	...
	mounted(){
		...
		if(this.$route.query.pageFlag=='register'){
			...
			if ('nongchangzhu' == this.tableName) {
				this.rules.nongchangzhanghao = [{ required: true, message: '请输入农场账号', trigger: 'blur' }]
			}
			if ('nongchangzhu' == this.tableName) {
	...
	methods: {
		...
		login() {
			var url=this.tableName+"/register";
					if((!this.ruleForm.nongchangzhanghao) && `nongchangzhu` == this.tableName){
						this.$message.error(`农场账号不能为空`);
						return
					}
					if((!this.ruleForm.fuzeren) && `nongchangzhu` == this.tableName){
            ...
            if(this.ruleForm.touxiang!=null) {
                this.ruleForm.touxiang = this.ruleForm.touxiang.replace(new RegExp(this.$base.url,"g"),"");
					...
					if(`nongchangzhu` == this.tableName && this.ruleForm.dianhuahaoma &&(!this.$validate.isMobile(this.ruleForm.dianhuahaoma))){
            ...
            if(this.ruleForm.touxiang!=null) {
                this.ruleForm.touxiang = this.ruleForm.touxiang.replace(new RegExp(this.$base.url,"g"),"");
					...
					if(`zhuanjia` == this.tableName && this.ruleForm.lianxidianhua &&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
