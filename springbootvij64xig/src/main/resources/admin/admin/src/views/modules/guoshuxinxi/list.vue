<template>
	<div class="main-content" :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"14px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('guoshuxinxi','制定计划')" @click="shengzhangjihuaCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
		...
		<shengzhangjihua-cross-add-or-update v-if="shengzhangjihuaCrossAddOrUpdateFlag" :parent="this" ref="shengzhangjihuaCrossaddOrUpdate"></shengzhangjihua-cross-add-or-update>
...
import shengzhangjihuaCrossAddOrUpdate from "../shengzhangjihua/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				shengzhangjihuaCrossAddOrUpdateFlag: false,
		...
		components: {
			AddOrUpdate,
			shengzhangjihuaCrossAddOrUpdate,
		},
		methods: {
			contentStyleChange() {
			...
			shengzhangjihuaCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.shengzhangjihuaCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.shengzhangjihuaCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.shengzhangjihuaCrossaddOrUpdate.init(row.id,type);
				});
			},
