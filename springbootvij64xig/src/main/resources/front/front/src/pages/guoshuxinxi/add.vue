...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="果树类型" prop="guoshuleixing">
            <el-select v-model="ruleForm.guoshuleixing" placeholder="请选择果树类型" :disabled=" false  ||ro.guoshuleixing" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="健康状况" prop="jiankangzhuangkuang">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="生长状态" prop="shengzhangzhuangtai">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="生长状态"
      ...
      init(type) {
        ...
        this.$http.get(this.userTableName + '/session', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            ...
            if((json.nongchangzhanghao!=''&&json.nongchangzhanghao) || json.nongchangzhanghao==0){
