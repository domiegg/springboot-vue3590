...
public class NongchangzhuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		NongchangzhuEntity u = nongchangzhuService.selectOne(new EntityWrapper<NongchangzhuEntity>().eq("nongchangzhanghao", username));
    ...
    public R register(@RequestBody NongchangzhuEntity nongchangzhu){
    	...
    	NongchangzhuEntity u = nongchangzhuService.selectOne(new EntityWrapper<NongchangzhuEntity>().eq("nongchangzhanghao", nongchangzhu.getNongchangzhanghao()));
		if(u!=null) {
    ...
    public R save(@RequestBody NongchangzhuEntity nongchangzhu, HttpServletRequest request){
        if(nongchangzhuService.selectCount(new EntityWrapper<NongchangzhuEntity>().eq("nongchangzhanghao", nongchangzhu.getNongchangzhanghao()))>0) {
            return R.error("农场账号已存在");
        }
    ...
    public R update(@RequestBody NongchangzhuEntity nongchangzhu, HttpServletRequest request){
        //ValidatorUtils.validateEntity(nongchangzhu);
        if(nongchangzhuService.selectCount(new EntityWrapper<NongchangzhuEntity>().ne("id", nongchangzhu.getId()).eq("nongchangzhanghao", nongchangzhu.getNongchangzhanghao()))>0) {
            return R.error("农场账号已存在");
        }
